...
class nvd3_discreteBarChart
{
    ...
    public function __construct($chart)
    {
        ...
        wp_enqueue_script('nvd3-discretebar', $this->nvd3Settings->wpbi_url['nvd3']['discretebar'], ['nvd3-nvd3'] );
        wp_enqueue_script('nvd3-discretebarchart', $this->nvd3Settings->wpbi_url['nvd3']['discretebarchart'], ['nvd3-nvd3'] );
    }
